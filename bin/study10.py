...
if __name__ == "__main__":
    ...
    dimensionsVectors_path2_fa = 'Integrating_SCM_SD/bin/output/dimensions_fasttext.npy'
    dimensionsVectors_path3_gl = 'Integrating_SCM_SD/bin/output/dimensions_glove.npy'
